...
//
// Reads through the R2 bucket binding so edits (see PUT below) are visible
// immediately — the public-URL path is CDN-cached. Legacy rows without an
...
// PUT /api/library-notebooks/{id}/files/{fileId}/content  → overwrite text
