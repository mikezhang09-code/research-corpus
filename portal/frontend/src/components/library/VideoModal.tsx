...
export function VideoModal({
  ...
  return (
    ...
    >
      <div className="bg-vellum rounded-[2px] border border-ink shadow-[4px_4px_0_rgb(42_36_24_/_0.18)] w-full max-w-4xl flex flex-col overflow-hidden">
        ...
        <div className="p-4 bg-ink">
          <video controls src={src} className="w-full max-h-[70vh] rounded-[1px]">
