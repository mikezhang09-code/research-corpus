...
export function FolioCard({
  ...
  return (
    <article
      onClick={onClick}
      className="cursor-pointer transition-transform hover:-translate-y-px h-[280px]"
      style={accentStyle}
    >
      <div
        className={`cover-${cover} h-full flex flex-col`}
      ...
      >
        ...
        <p className="font-serif text-[13.5px] leading-[1.4] text-ink-soft line-clamp-2 mb-2 flex-1 min-h-0">
          {excerpt}
        </p>

        <div className="mt-auto pt-2 border-t border-rule-light flex items-center justify-between gap-3">
