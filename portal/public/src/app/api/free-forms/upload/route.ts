...
// POST /api/free-forms/upload  (multipart/form-data)
// Mirrors upload_free_form_file() in portal/backend/routers/free_forms.py.
export async function POST(req: NextRequest) {
  ...
  const tagsField = ((form.get("tags") as string | null) ?? "").trim();
